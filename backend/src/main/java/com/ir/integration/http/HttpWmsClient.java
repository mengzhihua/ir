...
public class HttpWmsClient implements WmsClient {
    ...
    public HttpWmsClient(RestTemplate http, String baseUrl) { this.http = http; this.baseUrl = baseUrl; }
    public List<WmsOrderSnapshot> fetchOutbound() { return Collections.emptyList(); }
    public List<InventorySnapshot> fetchInventorySummary() { return Collections.emptyList(); }
