...
public class ScenarioParams {
    ...
    private Map<String,BigDecimal> channelDemandMultiplier=new LinkedHashMap<>();
    ...
    private BigDecimal storageCostPerUnitDay=BigDecimal.valueOf(.02);
    private BigDecimal handlingCostPerOrder=BigDecimal.valueOf(1.5);
    private BigDecimal packagingCostPerOrder=BigDecimal.valueOf(.8);
    ...
    public ScenarioParams(){carrierMix.put("SF",BigDecimal.valueOf(.4));carrierMix.put("JDL",BigDecimal.valueOf(.3));carrierMix.put("SELF",BigDecimal.valueOf(.3));carrierRate.put("SF",BigDecimal.valueOf(2.2));carrierRate.put("JDL",BigDecimal.valueOf(1.8));carrierRate.put("SELF",BigDecimal.valueOf(1.4));}
}
