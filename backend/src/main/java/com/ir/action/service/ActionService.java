...
public class ActionService {
    ...
    public List<Map<String, Object>> types() {
        return Arrays.asList(
                ...
                type("BOM_SUBMIT_ECN", "BOM", field("ecnNo", "ECN 编号", true)),
                type("BOM_APPROVE_ECN", "BOM", field("ecnNo", "ECN 编号", true)),
                type("BOM_IMPLEMENT_ECN", "BOM", field("ecnNo", "ECN 编号", true)),
                type("INV_SUBMIT_REQUEST", "INV", field("requestNo", "开票申请号", true)),
                type("INV_APPROVE_REQUEST", "INV", field("requestNo", "开票申请号", true)),
                type("INV_VERIFY_INPUT", "INV", field("invoiceNo", "进项发票号", true)),
