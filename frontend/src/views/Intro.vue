...
const compare = [
  ...
  },
  {
    ...
    ours: 'TMS 按时效、费率或历史评分择优，已送达订单可另开回货单',
    next: '电子面单从模拟取号改成实连'
  },
  {
...
const systems = [
  ...
  { kicker: '执行', name: 'TMS 运配', text: '运单、发车、在途和签收。调度台按时效、成本、平衡或历史评分选承运商，送达后可开回货单。' },
...
const phases = [
  ...
  },
  {
    ...
    title: '评分、回货和计件金额',
    lines: [
      '承运商按准时 50、无异常 30、费用贴合 20 记分，评分优先没有历史时改用平衡',
      '已送达订单另开回货单，收发双方对调，签收不回写原销售订单',
      '仓库计件：拣货 0.50 元/件，发运 0.40，上架 0.30，收货 0.20，补货 0.35，拒收 0.25'
    ]
  },
  {
    stage: '下一阶段',
