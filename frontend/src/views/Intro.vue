<template>
  <div class="intro">
    ...
    <section class="block">
      <h2>和震坤行采购商城怎么对上</h2>
      <p class="note">对照的是 zkh.com 公开讲的找货、协议价、需求清单和批量询价，不是把对方的商品数量、仓网或送达时效写到我们头上。选品按品类分组，不是完整商城店面。</p>
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
...
const zkh = [
  {
    ...
    ours: '选品按品类分组。卡片上有品牌和制造商料号，空品类归到未分品类',
    next: '按工厂维护可买的商品池。现在按品类分组，还不是完整商城店面'
  },
  {
    theirs: '协议价、折扣和批量询价后立刻下单',
    ours: '同一张选品卡列出数量 1 的协议价，以及满 10 件九五折、满 100 件九折',
    next: '折扣档按合同配置。现在是固定两档，没有协议价就不显示牌价'
  },
  {
    theirs: '需求清单先收集，再核对匹配结果',
    ours: '可以收藏、记下最近 20 条浏览，并保存自己的优惠券百分比。选品可以直接加入需求清单',
    next: '优惠券还没有有效期和使用次数。也没有移动采购和邮件审批'
  }
]
const systems = [
  ...
  { kicker: '供应', name: 'SRM / BOM / DMS', text: '采购申请、询价和协议价。选品按品类看折扣档，可收藏、记浏览和自存优惠券。未匹配的需求不转申请。' },
