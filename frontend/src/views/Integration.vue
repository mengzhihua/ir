  ...
  <div class="page">
    ...
    <div class="panel">
      ...
      <el-table :data="logs" stripe
        ><el-table-column prop="systemCode" label="系统" /><el-table-column
          prop="status"
          label="状态"
        ...
        ><el-table-column prop="message" label="结果" /><el-table-column
          prop="startedAt"
          label="开始时间"
          ><template #default="{ row }">{{ formatDate(row.startedAt) }}</template></el-table-column
    ...
    <el-dialog v-model="visible" title="编辑系统连接"
      ><el-form label-width="100px"
        ><el-form-item label="Base URL"><el-input v-model="editing.baseUrl" /></el-form-item
        ><el-form-item label="认证方式"
          ><el-select v-model="editing.authType"
            ><el-option label="无" value="NONE" /><el-option
              label="Bearer"
              value="BEARER" /><el-option
              label="API Key"
              value="API_KEY" /></el-select></el-form-item
        ><el-form-item label="用户名"><el-input v-model="editing.username" /></el-form-item
        ><el-form-item label="密码"
          ><el-input v-model="editing.password" type="password" show-password /></el-form-item
        ><el-form-item label="API Key"><el-input v-model="editing.apiKey" /></el-form-item></el-form
      ><template #footer
